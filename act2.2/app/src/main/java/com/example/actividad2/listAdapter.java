...
public class listAdapter extends RecyclerView.Adapter<listAdapter.AmigosViewHolder>{
    ...
    public listAdapter(ArrayList<String> data, View.OnClickListener listener){
    ...
    public void onBindViewHolder(@NonNull AmigosViewHolder holder, int position) {
        try{
            ...
            holder.rowText1.setText(temp.getString("name"));
            holder.rowText2.setText(temp.getString("price"));
